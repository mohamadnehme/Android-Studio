...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new Sqlite(this);
        i1 = getIntent();
        //Toast.makeText(this,i1.getExtras().getInt("id")+ i1.getStringExtra("email") + i1.getStringExtra("pass"),Toast.LENGTH_SHORT).show();
    ...
    public void next(View v) {
            if (click == 1) {
                ...
                final int pr = score * 10;
                int wrong = 10 - score;
                    User u = db.getuser(i1.getExtras().getInt("id"));
                    String ms;
                    if(score > Integer.parseInt(u.getScore())){
                        ms = "New High Score!";
                        db.update(Integer.toString(u.getId()),Integer.toString(score));
                    }
                    else {
                        ms = "Finish";
                    }
                AlertDialog.Builder builder = new AlertDialog.Builder(MainActivity.this);
                builder.setMessage(Integer.toString(wrong) + " Mauvais Click ," + pr + "%correctes")
                        .setTitle(ms)
                        .setPositiveButton("Reinitialiser le Quiz", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                x.putExtra("id",i1.getExtras().getInt("id"));
                                x.putExtra("email",i1.getStringExtra("email"));
                                x.putExtra("pass",i1.getStringExtra("pass"));
